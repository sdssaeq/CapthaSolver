...
exports.isCudaAvailable = exports.requireCmake = exports.requireGit = exports.spawn = exports.execFile = exports.execSync = exports.exec = exports.formatNumber = exports.light = exports.highlight = exports.toExecCmd = exports.protect = void 0;
...
function spawn(cmd, args, options, filters) {
    ...
    return new Promise(function (resolve, reject) {
        try {
            const child = child_process_1.default.spawn(cmd, args, Object.assign({ stdio: ['inherit', 'pipe', 'pipe'] }, options));
...
function isCudaAvailable() {
    ...
    const cudaVersionFilePathTxt = path_1.default.resolve(cudeFileTxt);
    const cudaVersionFilePathJson = path_1.default.resolve(cudeFileJson);
    if (fs_1.default.existsSync(cudaVersionFilePathTxt)) {
        const content = fs_1.default.readFileSync(cudaVersionFilePathTxt, 'utf8');
        npmlog_1.default.info('install', content);
        return true;
    }
    if (fs_1.default.existsSync(cudaVersionFilePathJson)) {
        const content = fs_1.default.readFileSync(cudaVersionFilePathJson, 'utf8');
        npmlog_1.default.info('install', content);
        return true;
    }
    npmlog_1.default.info('install', `CUDA version file could not be found in /usr/local/cuda/version.{txt,json}.`);
    return false;
}
